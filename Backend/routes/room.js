...
const { addBooking, deleteBooking, getBooking } = require('../controllers/booking')
...
router.get('/', async (req, res) => {
	...
	// Фильтруем комнаты, которые не пересекаются с выбранным диапазоном дат
...
router.delete('/:id/bookings', authenticated, async (req, res) => {
